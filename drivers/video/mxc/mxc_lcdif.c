...
static struct fb_videomode lcdif_modedb[] = {
	...
	0,},
  {
	...
	"QY-LCD-640X480", 60, 640, 480, 25000, 16, 48, 11, 31, 96, 2,
	FB_SYNC_CLK_LAT_FALL,
	//FB_SYNC_CLK_IDLE_EN,
	FB_VMODE_NONINTERLACED,
	0,},
	...
	0,},
	{
  /* 1280X1024 @ 60 Hz , pixel clk @ 32MHz */
	"QY-VGA-1280X1024", 60, 1280, 1024, KHZ2PICOS(109004), 216, 80,	3, 29, 136, 7,
	//FB_SYNC_CLK_LAT_FALL,
	...
	"QY-VGA-1366X768", 60,1366, 768, KHZ2PICOS(84753), 208, 72, 3, 17, 136, 10,
	FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT,
	FB_VMODE_ODD_FLD_FIRST, 0
	},
	{
	/* VGA 1440x900 60M pixel clk output */
	"QY-VGA-1440X900", 60,1440, 900, KHZ2PICOS(106508), 232, 80, 3, 25, 152, 6, 
	FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT,
	FB_VMODE_ODD_FLD_FIRST, 0
	},
};
